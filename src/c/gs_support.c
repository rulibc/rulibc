#if defined(_WIN32)
/* Copy from https://github.com/mirror/mingw-w64/tree/master/mingw-w64-crt/crt */
/**
...
#ifdef _WIN64
#define DEFAULT_SECURITY_COOKIE 0x00002B992DDFA232llu
#else
...
__report_gsfailure (ULONG_PTR StackCookie)
{
  ...
  TerminateProcess (GetCurrentProcess (), (UINT)STATUS_STACK_BUFFER_OVERRUN);
  abort();
}
